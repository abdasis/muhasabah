        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card">
                    <h5 class="card-header border-light d-flex align-items-center">
                        <div class="form-check form-switch form-switch-md" dir="ltr">
                            <x-form-input name="is_purchaseable" wire:model.lazy="is_purchaseable" type="checkbox"
                                          class="form-check-input" id="is-purchaseable"/>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-form-select label="Akun Pembelian" name="purchase_account"
                                               wire:model.lazy="purchase_account">
                                    <option value="">Pilih Akun</option>
                                    @foreach($accounts as $account)
                                        <option value="{{ $account->id }}">{{ $account->name }}</option>
                                    @endforeach
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if($image && $product->images)
                            <figure class="figure">
                                <img src="{{ $image->temporaryUrl() }}" height="150px"
                                     class="figure-img img-fluid rounded" alt="...">
                            </figure>
                        @elseif($product->images && empty($image))
                            <figure class="figure">
                                <img src="{{ asset("products/{$product->images}") }}" height="150px"
                                     class="figure-img img-fluid rounded" alt="...">
                            </figure>
                        @elseif($image && empty($product->images))
                            <figure class="figure">
                                <img src="{{ $image->temporaryUrl() }}" height="150px"
                                     class="figure-img img-fluid rounded" alt="...">
                            </figure>
...
@push('scripts')
    <script>
        ...
        Livewire.onLoad(() => {
            $('#categories').val(@this.category_id
        ).
            trigger('change');
        })
